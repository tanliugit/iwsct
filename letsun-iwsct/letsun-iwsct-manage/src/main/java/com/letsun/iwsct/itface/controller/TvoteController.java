 ...
 */
@Controller
@RequestMapping("/itface/tvote/")
public class TvoteController extends BaseAdminController {
	
	@Autowired private TvoteService tvoteService;
	...
	@ResponseBody
	@RequestMapping("list")
	public  Map<String, Object> search(Tvote entity, Integer page,Integer limit) {
		return toLayuiList(tvoteService.selectPage(entity, page, limit));
	}
	...
	public Message addSave(Tvote entity){
		entity.setCreator(getLoginUser().getAccount());
		entity.setCreateDate(new Date());
		return tvoteService.insert(entity) ? Message.success("操作成功") : Message.error("操作失败");		
	}
	...
	public String edit(Long id, ModelMap mmap){
		mmap.put("obj", tvoteService.selectById(id));
		return "/itface/tvote/edit";
	}
	...
	public Message editSave(Tvote entity, ModelMap mmap){
		entity.setModifier(getLoginUser().getAccount());
		entity.setModifyDate(new Date());
		return tvoteService.updateById(entity) ? Message.success("操作成功") : Message.error("操作失败");	
	}	
	...
	public Message delete(Long id){
		return tvoteService.deleteById(id) ? Message.success("操作成功") : Message.error("操作失败");		
	}
