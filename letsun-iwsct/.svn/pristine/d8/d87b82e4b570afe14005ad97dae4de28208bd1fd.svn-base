...
import com.letsun.iwsct.itface.mapper.TlotteryRecordMapper;
 ...
 */
@Service
public class TlotteryRecordServiceImpl extends BaseServiceImpl<TlotteryRecordMapper,TlotteryRecord> implements TlotteryRecordService{
