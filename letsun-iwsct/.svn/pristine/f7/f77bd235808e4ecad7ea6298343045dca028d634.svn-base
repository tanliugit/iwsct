 ...
 */
@Controller
@RequestMapping("/itface/tcorp/")
public class TcorpController extends BaseAdminController {
	
	@Autowired private TcorpService tcorpService;
	...
	@ResponseBody
	@RequestMapping("list")
	public  Map<String, Object> search(Tcorp entity, Integer page,Integer limit) {
		return toLayuiList(tcorpService.selectPage(entity, page, limit));
	}
	...
	public Message addSave(Tcorp entity){
		entity.setCreator(getLoginUser().getAccount());
		entity.setCreateDate(new Date());
		return tcorpService.insert(entity) ? Message.success("操作成功") : Message.error("操作失败");		
	}
	...
	public String edit(Long id, ModelMap mmap){
		mmap.put("obj", tcorpService.selectById(id));
		return "/itface/tcorp/edit";
	}
	...
	public Message editSave(Tcorp entity, ModelMap mmap){
		entity.setModifier(getLoginUser().getAccount());
		entity.setModifyDate(new Date());
		return tcorpService.updateById(entity) ? Message.success("操作成功") : Message.error("操作失败");	
	}	
	...
	public Message delete(Long id){
		return tcorpService.deleteById(id) ? Message.success("操作成功") : Message.error("操作失败");		
	}
