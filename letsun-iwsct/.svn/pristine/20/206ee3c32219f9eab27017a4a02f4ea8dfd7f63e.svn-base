 ...
 */
@Controller
@RequestMapping("/itface/tfans/")
public class TfansController extends BaseAdminController {
	
	@Autowired private TfansService tfansService;
	...
	@ResponseBody
	@RequestMapping("list")
	public  Map<String, Object> search(Tfans entity, Integer page,Integer limit) {
		return toLayuiList(tfansService.selectPage(entity, page, limit));
	}
	...
	public Message addSave(Tfans entity){
		entity.setCreator(getLoginUser().getAccount());
		entity.setCreateDate(new Date());
		return tfansService.insert(entity) ? Message.success("操作成功") : Message.error("操作失败");		
	}
	...
	public String edit(Long id, ModelMap mmap){
		mmap.put("obj", tfansService.selectById(id));
		return "/itface/tfans/edit";
	}
	...
	public Message editSave(Tfans entity, ModelMap mmap){
		entity.setModifier(getLoginUser().getAccount());
		entity.setModifyDate(new Date());
		return tfansService.updateById(entity) ? Message.success("操作成功") : Message.error("操作失败");	
	}	
	...
	public Message delete(Long id){
		return tfansService.deleteById(id) ? Message.success("操作成功") : Message.error("操作失败");		
	}
