...
public class ${className}Controller extends BaseAdminController {
	...
	@Autowired private ${className}Service ${classNameFirstLower}Service;
	...
	public String index() {
		return "/${moduleName}/${classNameFirstLower}/index";
	}	
	...
	public  Map<String, Object> search(${className} entity, Integer page,Integer limit) {
		return toLayuiList(${classNameFirstLower}Service.selectPage(entity, page, limit));
	}
	...
	public String add() {
		return "/${moduleName}/${classNameFirstLower}/add";
	}	
	...
	public Message addSave(${className} entity){
		...
		return ${classNameFirstLower}Service.insert(entity) ? Message.success("操作成功") : Message.error("操作失败");		
	}
	...
	public String edit(Long id, ModelMap mmap){
		mmap.put("obj", ${classNameFirstLower}Service.selectById(id));
		return "/${moduleName}/${classNameFirstLower}/edit";
	}
	...
	public Message editSave(${className} entity, ModelMap mmap){
		...
		return ${classNameFirstLower}Service.updateById(entity) ? Message.success("操作成功") : Message.error("操作失败");	
	}	
	...
	public String detail(Long id, ModelMap mmap){
		mmap.put("obj", ${classNameFirstLower}Service.selectById(id));
		return "/${moduleName}/${classNameFirstLower}/detail";
	}
	...
	public Message delete(Long id){
		return ${classNameFirstLower}Service.deleteById(id) ? Message.success("操作成功") : Message.error("操作失败");		
	}
